...
!(function(root, factory) {
  ...
  if ("object" == typeof exports) return (module.exports = factory());
  root.cloudinary || (root.cloudinary = {}), (ref = factory()), (results = []);
  for (name in ref)
    (value = ref[name]), results.push((root.cloudinary[name] = value));
})(this, function() {
  var ArrayParam,
    BaseUtil,
    ClientHintsMetaTag,
  ...
  _ = function() {
    ...
    function baseClone(value, bitmask, customizer, key, object, stack) {
      ...
      if (isArr) {
        ...
        if (tag == objectTag || tag == argsTag || (isFunc && !object)) {
          if (
            ((result = isFlat || isFunc ? {} : initCloneObject(value)), !isDeep)
          )
            return isFlat
    ...
    function cloneMap(map, isDeep, cloneFunc) {
      return arrayReduce(
        isDeep ? cloneFunc(mapToArray(map), CLONE_DEEP_FLAG) : mapToArray(map),
        addMapEntry,
        new map.constructor()
      );
    }
    ...
    function cloneSet(set, isDeep, cloneFunc) {
      return arrayReduce(
        isDeep ? cloneFunc(setToArray(set), CLONE_DEEP_FLAG) : setToArray(set),
        addSetEntry,
        new set.constructor()
      );
    }
    ...
    var cloneableTags = {};
    (cloneableTags[argsTag] = cloneableTags["[object Array]"] = cloneableTags[
      arrayBufferTag
      ...
      (cloneableTags["[object Error]"] = cloneableTags[funcTag] = cloneableTags[
        weakMapTag
      ] = !1);
  ...
  return (
    ...
    (without = function(array, item) {
      ...
      for (newArray = [], i = -1, length = array.length; ++i < length; )
        array[i] !== item && newArray.push(array[i]);
      return newArray;
    }),
    ...
    (smartEscape = function(string, unsafe) {
      return (
        null == unsafe && (unsafe = /([^a-zA-Z0-9_.\-\/:]+)/g),
        string.replace(unsafe, function(match) {
          return match
            .split("")
            .map(function(c) {
              return (
    ...
    (defaults = function() {
      ...
      return (
        ...
        sources.reduce(function(dest, source) {
          var key, value;
          for (key in source)
            (value = source[key]), void 0 === dest[key] && (dest[key] = value);
          return dest;
        }, destination)
      );
    }),
    ...
    (camelCase = function(source) {
      ...
      return (
        ...
        (words = (function() {
          var j, len, results;
          for (results = [], i = j = 0, len = words.length; j < len; i = ++j)
            (word = words[i]),
    ...
    (snakeCase = function(source) {
      ...
      return (
        ...
        (words = (function() {
          var j, len, results;
          for (results = [], i = j = 0, len = words.length; j < len; i = ++j)
            (word = words[i]), results.push(word.toLocaleLowerCase());
          return results;
        })()),
        words.join("_")
      );
    ...
    (convertKeys = function(source, converter) {
      ...
      for (key in source)
        (value = source[key]),
          (key = converter(key)),
          Util.isEmpty(key) || (result[key] = value);
      return result;
    }),
    ...
    (base64Encode =
      "undefined" != typeof btoa && isFunction(btoa)
        ? btoa
        : "undefined" != typeof Buffer && isFunction(Buffer)
        ? function(input) {
            return (
    ...
    (contains = function(a, b) {
      ...
      return (
        ...
        (bup = b && b.parentNode),
        a === bup || !(!bup || 1 !== bup.nodeType || !adown.contains(bup))
      );
    }),
    ...
    (cssValue = function(elem, name, convert, styles) {
      var val;
      return (
        (val = curCSS(elem, name, styles)), convert ? parseFloat(val) : val
      );
    }),
    (augmentWidthOrHeight = function(elem, name, extra, isBorderBox, styles) {
      ...
      for (
        sides = "width" === name ? ["Right", "Left"] : ["Top", "Bottom"],
          val = 0,
          j = 0,
          len = sides.length;
        j < len;
        ...
        (side = sides[j]),
          "margin" === extra &&
            (val += cssValue(elem, extra + side, !0, styles)),
          isBorderBox
            ? ("content" === extra &&
                (val -= cssValue(elem, "padding" + side, !0, styles)),
              "margin" !== extra &&
                (val -= cssValue(elem, "border" + side + "Width", !0, styles)))
            : ((val += cssValue(elem, "padding" + side, !0, styles)),
              "padding" !== extra &&
                (val += cssValue(elem, "border" + side + "Width", !0, styles)));
      return val;
    ...
    (getWidthOrHeight = function(elem, name, extra) {
      ...
      if (
        ...
        (isBorderBox =
          "border-box" === cssValue(elem, "boxSizing", !1, styles)),
        val <= 0 || null == val)
      ) {
        if (
      ...
      for (
        ...
        (c1 = string.charCodeAt(n)),
          ...
          c1 < 128
            ...
            : (enc =
                c1 > 127 && c1 < 2048
                  ? String.fromCharCode((c1 >> 6) | 192, (63 & c1) | 128)
                  : String.fromCharCode(
                      (c1 >> 12) | 224,
                      ((c1 >> 6) & 63) | 128,
                      (63 & c1) | 128
          ...
          null !== enc &&
            (end > start && (utftext += string.slice(start, end)),
            (utftext += enc),
            (start = end = n + 1)),
          n++;
    ...
    (crc32 = function(str) {
      ...
      for (
        ...
        (y = 255 & (crc ^ str.charCodeAt(i))),
          (x = "0x" + table.substr(9 * y, 8)),
          (crc = (crc >>> 8) ^ x),
          i++;
    ...
    (Layer = (function() {
      ...
      return (
        ...
        (Layer.prototype.getPublicId = function() {
          var ref;
          return null != (ref = this.options.publicId)
            ? ref.replace(/\//g, ":")
            : void 0;
        }),
        ...
        (Layer.prototype.toString = function() {
          var components;
          if (((components = []), null == this.options.publicId))
    ...
    (FetchLayer = (function(superClass) {
      function FetchLayer(options) {
        FetchLayer.__super__.constructor.call(this, options),
          Util.isString(options)
            ? (this.options.url = options)
            : (null != options ? options.url : void 0) &&
      ...
      return (
        ...
        (TextLayer.prototype.toString = function() {
          ...
          if (
            ...
            if (
              ...
              (hasPublicId && hasStyle) || (!hasPublicId && !hasStyle))
            )
        ...
        (TextLayer.prototype.textStyleIdentifier = function() {
          ...
          if (
            ...
            !Util.isEmpty(Util.compact(components)))
          ) {
    ...
    (Param = (function() {
      function Param(name, shortName, process) {
        null == process && (process = cloudinary.Util.identity),
          (this.name = name),
      ...
      return (
          ...
          return (
            ...
            (valid =
              ...
              cloudinary.Util.isString(val)
                ...
                : null != val),
            null != this.shortName && valid ? this.shortName + "_" + val : ""
          );
        }),
        ...
        (Param.prototype.build_array = function(arg) {
          return (
            null == arg && (arg = []),
            cloudinary.Util.isArray(arg) ? arg : [arg]
          );
        }),
            ...
            case Object:
              return (
                ...
                "codec" in param &&
                  ...
                  "profile" in param &&
                    ((video += ":" + param.profile),
                    "level" in param && (video += ":" + param.level))),
                video
              );
            case String:
              return param;
      ...
      return (
        ...
        (ArrayParam.prototype.serialize = function() {
          ...
          return null != this.shortName
            ? ((arrayValue = this.value()),
              cloudinary.Util.isEmpty(arrayValue)
                ? ""
                : cloudinary.Util.isString(arrayValue)
                ? this.shortName + "_" + arrayValue
                : ((flat = (function() {
                    var j, len, results;
                    for (
                      results = [], j = 0, len = arrayValue.length;
                      j < len;
                      j++
                    )
                      (t = arrayValue[j]),
        ...
        (ArrayParam.prototype.value = function() {
          ...
          if (cloudinary.Util.isArray(this.origValue)) {
            for (
              ref = this.origValue, results = [], j = 0, len = ref.length;
              j < len;
              j++
            )
              (v = ref[j]), results.push(this.process(v));
            return results;
          }
          return this.process(this.origValue);
        }),
        (ArrayParam.prototype.set = function(origValue) {
          return null == origValue || cloudinary.Util.isArray(origValue)
            ? ArrayParam.__super__.set.call(this, origValue)
            : ArrayParam.__super__.set.call(this, [origValue]);
        }),
        ArrayParam
      );
    ...
    (TransformationParam = (function(superClass) {
      ...
      return (
        ...
        (TransformationParam.prototype.serialize = function() {
          var joined, result, t;
          return cloudinary.Util.isEmpty(this.value())
            ? ""
            : cloudinary.Util.allStrings(this.value())
            ? ((joined = this.value().join(this.sep)),
              cloudinary.Util.isEmpty(joined)
                ? ""
                : this.shortName + "_" + joined)
            : ((result = function() {
                var j, len, ref, results;
                for (
                  ref = this.value(), results = [], j = 0, len = ref.length;
                  j < len;
                  j++
                )
                  null != (t = ref[j]) &&
                    (cloudinary.Util.isString(t) && !cloudinary.Util.isEmpty(t)
        ...
        (TransformationParam.prototype.set = function(origValue1) {
          return (
            ...
            cloudinary.Util.isArray(this.origValue)
              ? TransformationParam.__super__.set.call(this, this.origValue)
              : TransformationParam.__super__.set.call(this, [this.origValue])
          );
        }),
        TransformationParam
    ...
    (RangeParam = (function(superClass) {
      function RangeParam(name, shortName, process) {
        null == process && (process = this.norm_range_value),
      ...
      return (
        ...
        (RangeParam.norm_range_value = function(value) {
          var modifier, offset;
          return (
            (offset = String(value).match(
              new RegExp("^" + offset_any_pattern + "$")
            )),
            offset &&
              ((modifier = null != offset[5] ? "p" : ""),
      ...
      return (
        ...
        (LayerParam.prototype.value = function() {
          ...
          return (
            ...
            cloudinary.Util.isPlainObject(layerOptions)
              ? ((layerOptions = Util.withCamelCaseKeys(layerOptions)),
                (result =
                  "text" === layerOptions.resourceType ||
                  null != layerOptions.text
                    ? new cloudinary.TextLayer(layerOptions).toString()
                    : "subtitles" === layerOptions.resourceType
                    ? new cloudinary.SubtitlesLayer(layerOptions).toString()
                    : "fetch" === layerOptions.resourceType ||
                      null != layerOptions.url
                    ? new cloudinary.FetchLayer(layerOptions).toString()
                    : new cloudinary.Layer(layerOptions).toString()))
              : (result = /^fetch:.+/.test(layerOptions)
                  ? new FetchLayer(layerOptions.substr(6)).toString()
                  : layerOptions),
            result
          );
        }),
    ...
    (Expression = (function() {
      ...
      return (
        ...
        (Expression.prototype.predicate = function(name, operator, value) {
          return (
            null != Expression.OPERATORS[operator] &&
          ...
          if (
            null !=
              (cloudinary_url =
                ...
                null !== process &&
                null != (ref1 = process.env)
                  ? ref1.CLOUDINARY_URL
                  : void 0) &&
            ((uriRegex = /cloudinary:\/\/(?:(\w+)(?:\:([\w-]+))?@)?([\w\.-]+)(?:\/([^?]*))?(?:\?(.+))?/),
            (uri = uriRegex.exec(cloudinary_url)) &&
              (null != uri[3] && (this.configuration.cloud_name = uri[3]),
              null != uri[1] && (this.configuration.api_key = uri[1]),
              null != uri[2] && (this.configuration.api_secret = uri[2]),
              null != uri[4] &&
                (this.configuration.private_cdn = null != uri[4]),
              null != uri[4] &&
                (this.configuration.secure_distribution = uri[4]),
              null != (query = uri[5])))
          )
            for (
              ref2 = query.split("&"), j = 0, len = ref2.length;
              j < len;
              j++
            )
              (value = ref2[j]),
    ...
    (TransformationBase = (function() {
        ...
        null == options && (options = {}),
          ...
          this.toOptions ||
            (this.toOptions = function(withChain) {
              ...
              for (key in trans)
                (value = trans[key]), (opt[key] = value.origValue);
              ref = this.otherOptions;
              for (key in ref)
                void 0 !== (value = ref[key]) && (opt[key] = value);
              if (withChain && !Util.isEmpty(this.chained)) {
                (list = function() {
                  var j, len, ref1, results;
                  for (
                    ref1 = this.chained, results = [], j = 0, len = ref1.length;
                    j < len;
                    j++
                  )
                    (tr = ref1[j]), results.push(tr.toOptions());
                  return results;
                }.call(this)),
                  list.push(opt),
                  (opt = {}),
                ...
                for (key in ref1)
                  void 0 !== (value = ref1[key]) && (opt[key] = value);
          ...
          this.setParent ||
            (this.setParent = function(object) {
              return (
                ...
                null != object &&
                  this.fromOptions(
                    "function" == typeof object.toOptions
                      ? object.toOptions()
                      : void 0
                  ),
                this
          ...
          this.param ||
            (this.param = function(value, name, abbr, defaultValue, process) {
              return (
                null == process &&
                  (process = Util.isFunction(defaultValue)
                    ? defaultValue
                    : Util.identity),
          ...
          this.rawParam ||
            (this.rawParam = function(
              ...
              return (
                null == process && (process = Util.identity),
          ...
          this.arrayParam ||
            (this.arrayParam = function(
              ...
              return (
                ...
                null == process && (process = Util.identity),
                (process = lastArgCallback(arguments)),
                (trans[name] = new ArrayParam(name, abbr, sep, process).set(
                  value
                )),
                this
              );
          ...
          this.transformationParam ||
            (this.transformationParam = function(
              ...
              return (
                ...
                null == process && (process = Util.identity),
                (process = lastArgCallback(arguments)),
                (trans[name] = new TransformationParam(
                  name,
                  abbr,
                  sep,
                  process
          ...
          this.layerParam ||
            (this.layerParam = function(value, name, abbr) {
              return (
                (trans[name] = new LayerParam(name, abbr).set(value)), this
              );
            }),
          this.getValue ||
            (this.getValue = function(name) {
              var ref, ref1;
              return null !=
                (ref = null != (ref1 = trans[name]) ? ref1.value() : void 0)
                ? ref
            ...
            (this.remove = function(name) {
              ...
              switch (!1) {
                case null == trans[name]:
                  return (
                    (temp = trans[name]), delete trans[name], temp.origValue
                  );
            ...
            (this.toPlainObject = function() {
              ...
              for (key in trans)
                (hash[key] = trans[key].value()),
                  Util.isPlainObject(hash[key]) &&
                    (hash[key] = Util.cloneDeep(hash[key]));
              return (
                Util.isEmpty(this.chained) ||
                  ((list = function() {
                    var j, len, ref, results;
                    for (
                      ref = this.chained, results = [], j = 0, len = ref.length;
                      j < len;
                      j++
                    )
                      (tr = ref[j]), results.push(tr.toPlainObject());
                    return results;
                  }.call(this)),
                  list.push(hash),
          ...
          this.chain ||
            (this.chain = function() {
              ...
              return (
                ...
                0 !== names.length &&
                  ((tr = new this.constructor(this.toOptions(!1))),
      ...
      return (
        ...
        (lastArgCallback = function(args) {
          var callback;
          return (
            (callback = null != args ? args[args.length - 1] : void 0),
            Util.isFunction(callback) ? callback : void 0
          );
        }),
        (TransformationBase.prototype.fromOptions = function(options) {
          ...
          if (options instanceof TransformationBase)
            ...
            options || (options = {}),
              (Util.isString(options) || Util.isArray(options)) &&
            ...
            for (key in options)
              (opt = options[key]),
                key.match(VAR_NAME_RE)
                  ? "$attr" !== key && this.set("variable", key, opt)
                  : this.set(key, opt);
          }
          return this;
        }),
        (TransformationBase.prototype.fromTransformation = function(other) {
          ...
          if (other instanceof TransformationBase)
            for (ref = other.keys(), j = 0, len = ref.length; j < len; j++)
              (key = ref[j]), this.set(key, other.get(key).origValue);
          return this;
        }),
        (TransformationBase.prototype.set = function() {
          ...
          return (
            ...
            Util.contains(Transformation.methods, camelKey)
        ...
        (TransformationBase.prototype.serialize = function() {
          ...
          for (
            resultArray = function() {
              ...
              for (
                ...
                (tr = ref[j]), results.push(tr.serialize());
              return results;
            }.call(this),
              paramList = this.keys(),
              transformations =
                null != (ref = this.get("transformation"))
                  ? ref.serialize()
                  : void 0,
              ifParam =
                null != (ref1 = this.get("if")) ? ref1.serialize() : void 0,
              variables = processVar(
                null != (ref2 = this.get("variables")) ? ref2.value() : void 0
              ),
                ...
                ? vars.push(
                    t +
                      ...
                      Expression.normalize(
                        null != (ref3 = this.get(t)) ? ref3.value() : void 0
                      )
                  )
                : transformationList.push(
                    null != (ref4 = this.get(t)) ? ref4.serialize() : void 0
                  );
          switch (!1) {
          ...
          return (
            (transformationList = (function() {
              var l, len1, results;
              for (
                results = [], l = 0, len1 = transformationList.length;
                l < len1;
                l++
              )
            ...
            "if_end" === ifParam
              ...
              : Util.isEmpty(ifParam) || transformationList.unshift(ifParam),
            (transformationString = Util.compact(transformationList).join(
              this.param_separator
            )),
            Util.isEmpty(transformationString) ||
              resultArray.push(transformationString),
            Util.compact(resultArray).join(this.trans_separator)
          );
        }),
        ...
        (TransformationBase.prototype.toHtmlAttributes = function() {
          ...
          for (key in ref)
            (value = ref[key]),
              Util.contains(Transformation.PARAM_NAMES, Util.snakeCase(key)) ||
                ((attrName = /^html_/.test(key) ? key.slice(5) : key),
                (options[attrName] = value));
          for (ref1 = this.keys(), j = 0, len = ref1.length; j < len; j++)
            (key = ref1[j]),
              /^html_/.test(key) &&
          ...
          return (
            this.hasLayer() ||
              ...
              ((width =
                null != (ref2 = this.get("width")) ? ref2.origValue : void 0),
              (height =
                null != (ref3 = this.get("height")) ? ref3.origValue : void 0),
              parseFloat(width) >= 1 &&
                null == options.width &&
                (options.width = width),
              parseFloat(height) >= 1 &&
        ...
        (TransformationBase.prototype.toHtml = function() {
          var ref;
          return null != (ref = this.getParent()) &&
            "function" == typeof ref.toHtml
            ? ref.toHtml()
            : void 0;
        }),
        ...
        (processVar = function(varArray) {
          ...
          if (Util.isArray(varArray)) {
            for (results = [], j = 0, len = varArray.length; j < len; j++)
              (ref = varArray[j]),
                (name = ref[0]),
                (v = ref[1]),
      ...
      return (
        ...
        (Transformation.prototype.border = function(value) {
          return this.param(value, "border", "bo", function(border) {
            return Util.isPlainObject(border)
              ? ((border = Util.assign(
                  {},
                  { color: "black", width: 2 },
                  border
        ...
        (Transformation.prototype.if = function(value) {
          ...
          switch ((null == value && (value = ""), value)) {
            ...
            case "end":
              for (
                this.chain(), i = j = this.chained.length - 1;
                j >= 0 &&
                "end" !== (ifVal = this.chained[i].getValue("if")) &&
                (null == ifVal ||
        ...
        (Transformation.prototype.offset = function(value) {
          ...
          if (
            ((ref = Util.isFunction(null != value ? value.split : void 0)
              ? value.split("..")
              : Util.isArray(value)
              ? value
              : [null, null]),
            (start_o = ref[0]),
            (end_o = ref[1]),
            null != start_o && this.startOffset(start_o),
            null != end_o)
          )
        ...
        (Transformation.prototype.size = function(value) {
          var height, ref;
          if (Util.isFunction(null != value ? value.split : void 0))
            return (
              (ref = value.split("x")),
              (width = ref[0]),
              (height = ref[1]),
    ...
    Transformation.PARAM_NAMES ||
      (Transformation.PARAM_NAMES = (function() {
        var j, len, ref, results;
        for (
          ref = Transformation.methods, results = [], j = 0, len = ref.length;
          j < len;
          j++
        )
          (m = ref[j]), results.push(Util.snakeCase(m));
        return results;
    ...
    (HtmlTag = (function() {
      function HtmlTag(name, publicId, options) {
        ...
        (this.name = name),
          ...
          null == options &&
            (Util.isPlainObject(publicId)
              ? ((options = publicId), (this.publicId = void 0))
              : (options = {})),
      ...
      return (
        ...
        (HtmlTag.prototype.htmlAttrs = function(attrs) {
          ...
          return (function() {
            ...
            results = [];
            for (key in attrs)
              (value = attrs[key]) && results.push(toAttribute(key, value));
            return results;
          })()
            .sort()
            .join(" ");
        ...
        (HtmlTag.prototype.removeAttr = function(name) {
          var ref;
          return null != (ref = this.transformation().remove("html_" + name))
            ? ref
        ...
        (HtmlTag.prototype.openTag = function() {
          return (
            "<" + this.name + " " + this.htmlAttrs(this.attributes()) + ">"
          );
        }),
        ...
        (HtmlTag.isResponsive = function(tag, responsiveClass) {
          ...
          return (
            (dataSrc =
              Util.getData(tag, "src-cache") || Util.getData(tag, "src")),
            Util.hasClass(tag, responsiveClass) && /\bw_auto\b/.exec(dataSrc)
          );
        }),
        HtmlTag
      );
      ...
      return (
        ...
        (VideoTag.prototype.content = function() {
          ...
          return (
            ...
            Util.isArray(sourceTypes)
              ? ((cld = new Cloudinary(this.getOptions())),
                (innerTags = function() {
                  var j, len, results;
                  for (
                    results = [], j = 0, len = sourceTypes.length;
                    j < len;
                    j++
                  )
                    (srcType = sourceTypes[j]),
                      ...
                      (videoType = "ogv" === srcType ? "ogg" : srcType),
        ...
        (VideoTag.prototype.attributes = function() {
          ...
          for (
            sourceTypes = this.getOption("source_types"),
              poster = null != (ref = this.getOption("poster")) ? ref : {},
              Util.isPlainObject(poster) &&
                ((defaults =
                  null != poster.public_id
                    ? Cloudinary.DEFAULT_IMAGE_PARAMS
                    : DEFAULT_POSTER_OPTIONS),
                (poster = new Cloudinary(this.getOptions()).url(
                  null != (ref1 = poster.public_id) ? ref1 : this.publicId,
            ...
            (a = attr[j]), Util.contains(VIDEO_TAG_PARAMS) || (attr = a);
          return (
            Util.isArray(sourceTypes) ||
            ...
            null != poster && (attr.poster = poster),
            attr
          );
        }),
        VideoTag
    ...
    (Cloudinary = (function() {
      ...
      return (
        ...
        (finalizeResourceType = function(
          ...
          var key, options;
          if (
            (null == resourceType && (resourceType = "image"),
            null == type && (type = "upload"),
            Util.isPlainObject(resourceType) &&
          ...
          if (useRootPath) {
            if (
              ("image" !== resourceType || "upload" !== type) &&
              "images" !== resourceType
            )
        ...
        (Cloudinary.prototype.url = function(publicId, options) {
          ...
          if (
            (options instanceof Transformation &&
          ...
          if (
            (publicId.search("/") >= 0 &&
              ...
              !(null != (ref = options.version) ? ref.toString() : void 0) &&
              (options.version = 1),
            publicId.match(/^https?:/))
          )
            "upload" === options.type || "asset" === options.type
              ? (url = publicId)
        ...
        (Cloudinary.prototype.video_url = function(publicId, options) {
          return (
            ...
            this.url(publicId, options)
          );
        }),
        (Cloudinary.prototype.video_thumbnail_url = function(
          publicId,
          options
        ) {
          return (
        ...
        (Cloudinary.prototype.image = function(publicId, options) {
          ...
          return (
            ...
            (client_hints =
              null !=
                (ref =
                  null != (ref1 = options.client_hints)
                    ? ref1
                    : this.config("client_hints")) && ref),
            null != options.src || client_hints || img.setAttr("src", ""),
            (img = img.toDOM()),
            client_hints ||
        ...
        (Cloudinary.prototype.facebook_profile_image = function(
          publicId,
          options
        ) {
          return this.image(
            publicId,
            Util.assign({ type: "facebook" }, options)
          );
        }),
        (Cloudinary.prototype.twitter_profile_image = function(
          publicId,
          options
        ) {
          return this.image(
            publicId,
            Util.assign({ type: "twitter" }, options)
          );
        }),
        (Cloudinary.prototype.twitter_name_profile_image = function(
          ...
          return this.image(
            publicId,
            Util.assign({ type: "twitter_name" }, options)
          );
        }),
        (Cloudinary.prototype.gravatar_image = function(publicId, options) {
          return this.image(
            publicId,
            Util.assign({ type: "gravatar" }, options)
          );
        }),
        ...
        (Cloudinary.prototype.video = function(publicId, options) {
          return (
            null == options && (options = {}),
            this.videoTag(publicId, options).toHtml()
          );
        }),
        ...
        (Cloudinary.prototype.sprite_css = function(publicId, options) {
          return (
            ...
            publicId.match(/.css$/) || (options.format = "css"),
            this.url(publicId, options)
          );
        }),
        (Cloudinary.prototype.responsive = function(options, bootstrap) {
          ...
          if (
            (null == bootstrap && (bootstrap = !0),
            (this.responsiveConfig = Util.merge(
              this.responsiveConfig || {},
              options
            )),
            (responsiveClass =
              null != (ref = this.responsiveConfig.responsive_class)
                ? ref
            ...
            (null ==
              (ref1 =
                null != (ref2 = this.responsiveConfig.responsive_resize)
                  ? ref2
                  ...
                  return function() {
                    ...
                    return (
                      (debounce =
                        ...
                        (ref3 =
                          null !=
                          (ref4 = _this.responsiveConfig.responsive_debounce)
                            ? ref4
                            : _this.config("responsive_debounce"))
                          ? ref3
                          : 100),
                      (reset = function() {
                        if (timeout)
                      ...
                      (wait = function() {
                        return (
                          reset(), (timeout = setTimeout(waitFunc, debounce))
                        );
                      }),
                      debounce ? wait() : run()
                    );
        ...
        (Cloudinary.prototype.calc_breakpoint = function(
          element,
          width,
          steps
        ) {
          ...
          return (
            (breakpoints =
              ...
              defaultBreakpoints),
            Util.isFunction(breakpoints)
              ? breakpoints(width, steps)
              : (Util.isString(breakpoints) &&
                  (breakpoints = (function() {
                    ...
                    for (
                      ...
                      (point = ref[j]), results.push(parseInt(point));
                    return results;
                  })().sort(function(a, b) {
                    return a - b;
                  })),
        ...
        (Cloudinary.prototype.calc_stoppoint =
          Cloudinary.prototype.calc_breakpoint),
        (Cloudinary.prototype.device_pixel_ratio = function(roundDpr) {
          var dpr, dprString;
          return (
            null == roundDpr && (roundDpr = !0),
            (dpr =
              ("undefined" != typeof window && null !== window
                ? window.devicePixelRatio
                : void 0) || 1),
            roundDpr && (dpr = Math.ceil(dpr)),
            (dpr <= 0 || NaN === dpr) && (dpr = 1),
            (dprString = dpr.toString()),
            dprString.match(/^\d+$/) && (dprString += ".0"),
            dprString
          );
        }),
        (defaultBreakpoints = function(width, steps) {
          return (
            null == steps && (steps = 100), steps * Math.ceil(width / steps)
          );
        }),
        ...
        (cloudinaryUrlPrefix = function(publicId, options) {
          ...
          return 0 ===
            (null != (ref = options.cloud_name) ? ref.indexOf("/") : void 0)
            ? "/res" + options.cloud_name
            : ((protocol = "http://"),
              (cdnPart = ""),
              (subdomain = "res"),
              (host = ".cloudinary.com"),
              ...
              options.private_cdn &&
                ((cdnPart = options.cloud_name + "-"), (path = "")),
              options.cdn_subdomain &&
                (subdomain = "res-" + cdnSubdomainNumber(publicId)),
              options.secure
                ? ((protocol = "https://"),
                  !1 === options.secure_cdn_subdomain && (subdomain = "res"),
                  null != options.secure_distribution &&
          ...
          return (
            ...
            Util.isEmpty(nodes)
              ...
              : ((options = Util.defaults({}, options, this.config())),
                (images = function() {
                  var j, len, ref, results;
                  for (results = [], j = 0, len = nodes.length; j < len; j++)
                    (node = nodes[j]),
                      "IMG" ===
                        (null != (ref = node.tagName)
                          ? ref.toUpperCase()
                          : void 0) &&
          ...
          return (
            (responsive_use_breakpoints =
              ...
              (ref =
                null !=
                (ref1 =
                  null != (ref2 = options.responsive_use_breakpoints)
                    ? ref2
                    : options.responsive_use_stoppoints)
                  ? ref1
                  : this.config("responsive_use_breakpoints"))
                ? ref
                : this.config("responsive_use_stoppoints")),
            !responsive_use_breakpoints ||
            ("resize" === responsive_use_breakpoints && !options.resizing)
              ? width
              : this.calc_breakpoint(tag, width, steps)
          );
        }),
        (findContainerWidth = function(element) {
          ...
          for (
            containerWidth = 0;
            (element = null != element ? element.parentNode : void 0) instanceof
        ...
        (Cloudinary.prototype.cloudinary_update = function(elements, options) {
          var containerWidth,
            ...
            setUrl,
            tag;
          if ((null == options && (options = {}), null === elements))
            return this;
          for (
            responsive =
              null !=
                (ref =
                  null != (ref1 = options.responsive)
                    ? ref1
                    : this.config("responsive")) && ref,
              elements = (function() {
                switch (!1) {
              ...
              responsiveClass =
                null !=
                (ref2 =
                  null != (ref3 = this.responsiveConfig.responsive_class)
                    ? ref3
                    : options.responsive_class)
                  ? ref2
                  : this.config("responsive_class"),
              roundDpr =
                null != (ref4 = options.round_dpr)
                  ? ref4
            ...
            if (
              ((tag = elements[j]),
              (null != (ref5 = tag.tagName) ? ref5.match(/img/i) : void 0) &&
                ((setUrl = !0),
                responsive && Util.addClass(tag, responsiveClass),
                (dataSrc =
                  Util.getData(tag, "src-cache") || Util.getData(tag, "src")),
                !Util.isEmpty(dataSrc)))
            ) {
              if (
                ((dataSrc = updateDpr.call(this, dataSrc, roundDpr)),
                HtmlTag.isResponsive(tag, responsiveClass))
              )
                if (0 !== (containerWidth = findContainerWidth(tag))) {
                  ...
                  Util.removeAttribute(tag, "width"),
                    options.responsive_preserve_height ||
