...
This is handled from within the Netlify web app. You can find the options in **Settings > Forms > Form notifications**. Select the **Add notification** dropdown to see your options. I chose to keep things simple for now, receiving a notification by email.
